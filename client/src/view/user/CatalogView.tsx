import '../../style/views/items_catalog.css'
import { useState, useEffect } from "react";
import { useNavigate, useSearchParams } from "react-router-dom";
import { MultiComboBox } from "../../component/comboboxes/MultiComboBox";
import { SortBar } from '../../component/bars/SortBar';
import { publicApiRequests } from '../../network/request/PublicApiRequests';
import ItemViewDTO from '../../model/DTO/response/ItemViewDTO';
import ItemPreview from '../../component/singletons/ItemPreview';
...
export const CatalogView = (): JSX.Element => {
    ...
    useEffect(() => {
        setFetchStatus(-1);
        publicApiRequests.getItemList(searchParams, { onSuccess: onSuccessItemListFetch })
    }, [searchParams]);//or [rarirityOnSelection]
    useEffect(() => {
        switchPreload(true);
        setSearchParams({});
        publicApiRequests.getRarities({
